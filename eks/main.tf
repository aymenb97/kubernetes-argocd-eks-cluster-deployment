...
resource "aws_eks_cluster" "eks_cluster" {
  ...
  role_arn                  = coalesce(var.role_arn, aws_iam_role.eks_role[0].arn)
...
resource "aws_eks_node_group" "node" {
  ...
  node_role_arn   = coalesce(var.node_role_arn, aws_iam_role.eks_nodes_role[0].arn)
  subnet_ids      = var.subnet_ids
  ...
  remote_access {
    ec2_ssh_key               = coalesce(var.remote_access.ec2_ssh_key, aws_key_pair.generated[0].key_name)
